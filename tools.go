...
// CreateFullDirIfNotExist creates a directory, and all necessary parent directories, if it does not exist.
func (t *Tools) CreateFullDirIfNotExist(path string) error {
	const mode = 0755
	if _, err := os.Stat(path); os.IsNotExist(err) {
